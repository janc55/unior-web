export const conjuntosDomingo = [
    ...
    { grupo: 2, nombre: 'CONJ. TRAD. “LLAMERADA ZONA NORTE”', tipo_danza: 'Llamerada' },
    ...
    { grupo: 1, nombre: 'CONJ. CAPORALES INFANTILES IGNACIO LEÓN', tipo_danza: 'Caporales' },
     ...
     { grupo: 6, nombre: 'FRAT. MORENADA CENTRAL ORURO Fund. por la Com. Cocani', tipo_danza: 'Morenada' },
    ...
    // 🔹 Grupo 5
    { grupo: 5, nombre: 'DIABLADA ART. "URUS”', tipo_danza: 'Diablada' },
